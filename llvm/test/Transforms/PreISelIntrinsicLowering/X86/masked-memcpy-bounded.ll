...
; RUN: opt -mcpu=x86-64-v4 -passes=pre-isel-intrinsic-lowering -S < %s | FileCheck %s --check-prefixes=MASK,MASK256
; RUN: opt -mcpu=znver4    -passes=pre-isel-intrinsic-lowering -S < %s | FileCheck %s --check-prefixes=MASK,MASK512
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_bound_too_wide(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    [[CMP:%.*]] = icmp ult i64 [[SIZE]], 101
; MASK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_bound_zero(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    [[CMP:%.*]] = icmp ult i64 [[SIZE]], 1
; MASK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_unbounded(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_constant_length(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 32, i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_assume_does_not_dominate(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]], i1 [[C:%.*]]) #[[ATTR0]] {
; MASK-NEXT:  [[ENTRY:.*:]]
; MASK-NEXT:    br i1 [[C]], label %[[BOUND:.*]], label %[[COPY:.*]]
; MASK:       [[BOUND]]:
; MASK-NEXT:    [[CMP:%.*]] = icmp ult i64 [[SIZE]], 33
; MASK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; MASK-NEXT:    br label %[[COPY]]
; MASK:       [[COPY]]:
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memmove_unbounded(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    call void @llvm.memmove.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
  call void @llvm.memmove.p0.p0.i64(ptr %dst, ptr %src, i64 %size, i1 false)
  ret void
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_i128_unbounded(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i128 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i128(ptr [[DST]], ptr [[SRC]], i128 [[SIZE]], i1 false)
; MASK-NEXT:    ret void
;
...
; NOMASK-NEXT:    ret void
;
; MASK-LABEL: define void @memcpy_volatile_bounded(
; MASK-SAME: ptr [[DST:%.*]], ptr [[SRC:%.*]], i64 [[SIZE:%.*]]) #[[ATTR0]] {
; MASK-NEXT:    [[CMP:%.*]] = icmp ult i64 [[SIZE]], 33
; MASK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; MASK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[DST]], ptr [[SRC]], i64 [[SIZE]], i1 true)
; MASK-NEXT:    ret void
;
  %cmp = icmp ult i64 %size, 33
  call void @llvm.assume(i1 %cmp)
